...
namespace E3D {
	...
	ECamera::ECamera() :mLockTarget(false), mNeedUpdate(true), mRenderMode(RENDER_SOLID) {
		mFrustum = new EFrustum(CAMERA_MODEL_UVN, EVector4D::ZERO, EVector4D::ZERO, EVector4D::ZERO, 10
