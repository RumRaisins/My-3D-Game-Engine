...
namespace E3D {
	...
	void GetVertex4DAddVector4D(const EVector4D &v, const EVector4D& p, EVertex4D &result);
	//3D向量x44矩阵
	void GetVector3DMulMatrix44(const EVector3D& vec, const EMatrix44&mat, EVector4D &result);
	//3D向量x44矩阵
	void GetVector4DMulMatrix44(const EVector4D& vec, const EMatrix44&mat, EVector4D &result);

	void GetVertex3DMulMatrix44(const EVector4D& vec, const EMatrix44&mat, EVertex4D &result);
